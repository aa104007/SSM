...
FOR %%x IN ("C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\.\php.exe"
GOTO :INSTALLED
