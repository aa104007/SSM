...
GOTO doshift
:noshift
C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\.\php.exe -q -d output_buffering=1 -d include_path="\xampp\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%
