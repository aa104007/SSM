...
SET phpCli=C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "C:\Users\JBARIAS\Documents\GitHub\SSM\XAMPP\php\pear\phing.php" %*
GOTO :EOF
